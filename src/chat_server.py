...
def receive():
	while True:
		...
		print(f'apelido do cliente e {nickname}') # Mostra no server o apelido do cliente
		broadcast(f'{nickname} entrou no chat'.encode('ascii')) # faz um broadcast a todos sobre o cliente
